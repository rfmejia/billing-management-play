        ...
        var usersList = {
            ...
            resolve     : {
                ...
                r_combinedRoot      : function(usersService, invitesService, $q) {
                    ...
                    $q.all([usersService.getUserList()]).then(
                        function(response){
            ...
            views       : {
                "contentArea@workspace"  : {
                    templateUrl     : "app/components/workspace/users/views/maincontent-users-list.html",
        ...
        var usersView = {
            ...
            resolve     : {
                r_user          : function($stateParams, usersService) {
                    return usersService.getUser($stateParams.username);
                }
            },
            views       : {
                "contentArea@workspace"  : {
                    templateUrl     : "app/components/workspace/users/views/maincontent-users-view.html",
